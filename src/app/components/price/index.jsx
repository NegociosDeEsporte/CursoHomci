...
export default function Price(){
  return(
    ...
    <div className="flex flex-col items-center mt-5">
      ...
      <p className='text-white mt-20 text-center font-orbitron text-lg md:text-4xl font-bold px-20 '>Por a penas 12x 258,46</p>
      <p className='md:text-2xl font-bold text-amarelo text-center'>ou 2499 à vista</p>
