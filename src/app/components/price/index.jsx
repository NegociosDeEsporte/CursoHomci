...
export default function Price(){
  return(
    ...
    <div className="flex flex-col items-center mt-5">
      <p className="font-orbitron text-white text-lg md:text-4xl font-bold px-10 md:px-20 text-center">"Supere seus limites, alcance seu potencial máximo e conquiste a vitória com o nosso coaching esportivo personalizado com o  <span className='text-amarelo'>Prof. Marcelo Homci.</span> Desperte o campeão dentro de você!"</p>
      ...
      <p className='md:text-2xl font-bold text-white text-center'>ou <span className='text-amarelo'>R$ 2499,00 à vista</span></p>
